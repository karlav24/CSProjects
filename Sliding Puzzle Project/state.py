...
class State:
    ...
    def __init__(self, board, predecessor, move):
        """ Initializes all of the attributes present in the State Class"""
        self.board = board
    ...
    def is_goal(self):
        """ Determines if the tiles are in the goal state"""
    ...
    def generate_successors(self):
        """ Determines how many successors a move has"""
        successors = []
        for m in MOVES:
            b = self.board.copy()
    ...
    def print_moves_to(self):
        """ Prints the moves in the solution"""
